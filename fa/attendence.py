...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"C:\Users\Dell\Desktop\Update_FAMS\Images_GUI\banner.jpg")
        ...
        main_frame.place(x=5,y=55,width=1500,height=510)
        ...
        if self.var_id.get()=="" or self.var_roll.get=="" or self.var_name.get()=="" or self.var_time.get()=="" or self.var_date.get()=="" or self.var_attend.get()=="Status":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("update stdattendance set std_id=%s,std_roll=%s,std_name=%s,std_time=%s,std_date=%s,std_attendence=%s where std_id=%s",( 
                    self.var_id.get(),
                    self.var_roll.get(),
                    self.var_name.get(),
                    self.var_time.get(),
