...
class Student:
    ...
    def __init__(self,root):
        ...
        self.var_teacher=StringVar()
         ...
         #first image
        img=Image.open(r"C:\Users\Dell\Desktop\fa\images\Stanford.jpg")
        ...
        #third image
        img2=Image.open(r"C:\Users\Dell\Desktop\fa\images\2.jpg")
        ...
        #background image
        img3=Image.open(r"Images_GUI\bg.png")
        ...
        img_left=Image.open(r"Images_GUI\t_bg1.jpg")
        img_left=img_left.resize((720,130),Image.Resampling.LANCZOS) #converst high level image to low level
        self.photoimg_left=ImageTk.PhotoImage(img_left)
        
        
        f1=Label(Left_frame,image=self.photoimg_left)
        f1.place(x=5,y=0,width=720,height=130)
        ...
        studentID_entry.grid(row=0,column=3,padx=10,pady=5,sticky=W)
         ...
         #student_divison
        class_div_label=Label(class_Student_frame,text="Student Divison:",font=("times new roman",12,"bold"),bg="white")
        ...
        img_right=Image.open(r"Images_GUI\reg1.png")
        img_right=img_right.resize((720,130),Image.Resampling.LANCZOS) #converst high level image to low level
        self.photoimg_right=ImageTk.PhotoImage(img_right)
        
        
        f1=Label(Right_frame,image=self.photoimg_right)
        f1.place(x=5,y=0,width=650,height=130)
        ...
        showAll_btn=Button(Search_frame,command=self.fetch_data,text="Show All",width=10,font=("times new roman",12,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4,padx=4)
        
        #table frame
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=210,width=650,height=340)
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            messagebox.showerror("Error","Please Fill All Fields are Required!",parent=self.root)
              ...
              try:
                  ...
                  self.fetch_data()
                  conn.close()
                  messagebox.showinfo("Success","Student details filled successfully")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
                ...
                try:
                         ...
                         #=====load prefiend data on face from frontal face-opencv
                         ...
                         while True:
                               ...
                               if face_cropped(my_frame) is not None:
                                     img_id+=1
                               face=cv2.resize(face_cropped(my_frame),(200,200), interpolation=cv2.INTER_AREA)
                               face=cv2.cvtColor(face,cv2.COLOR_BGR2GRAY)
                               file_name_path="data_img/student."+str(id)+"."+str(img_id)+".jpg"
                         ...
                         messagebox.showinfo("Result","Generating dataset completed succsesfully",parent=self.root)
